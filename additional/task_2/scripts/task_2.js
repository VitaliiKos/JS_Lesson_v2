...
for (const user of usersList) {
    document.write('<div class="user-block">');
        ...
        document.write(`<h3> ${user.email}.</h3>`);
        document.write(`<h3> ${user.phone}.</h3>`);
        document.write(`<h3> ${user.website}.</h3>`);
        document.write('<div class="address-block">');
            for (const address in user.address) {
                if (typeof user.address[address] === "string"){
                document.write(`<p><b>${address}:</b> ${user.address[address]}</p>`);
                }else {
                    document.write(`<p><b>Geo:</b> </p>`);
                    document.write(`<p><b>Lat:</b> ${user.address[address].lat}</p>`);
                    document.write(`<p><b>Lng:</b> ${user.address[address].lng}</p>`);
                }
            }
        document.write('</div>');
    document.write('</div>');
